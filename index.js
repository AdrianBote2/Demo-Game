...
function animate() {
    ...
    if (currentMode === 'challenge') {
        ...
        if (pz < -5.8 && pz > -6.2 && !hasCheckpoint) {
            hasCheckpoint = true; checkLine.material.color.set(0x4ade80);
        }
        if (pz > 5.8 && pz < 6.2 && hasCheckpoint) {
    ...
    speedEl.innerText = currentVel.toFixed(2);
